...
const config = {
    path: './regularizacion_rh_ii.docx',
    fileName: 'regularizacion_rh_ii.docx'
}

const RegularizacionRHporII = () => {
    ...
    return ( 
        <AppLayout title={'Solicitud de Regularización RH por Ingreso Irregular'}>
            <Row>
                <Col xs={12} sm={12} md={6} lg={6} xl={6} className='d-flex flex-column justify-content-center'>
                    <Form>
                        ...
                        <Form.Group className="mb-3" controlId="formGroupPassword">
                            <Form.Label>CUR</Form.Label>
                            <Form.Control type="text"
                                placeholder="cur" 
                                onChange={({target}) => handlevalue('cur', target.value)}
                            />
                        </Form.Group>
...
export default RegularizacionRHporII;